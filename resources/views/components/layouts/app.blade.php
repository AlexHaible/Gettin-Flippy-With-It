...
<body
    ...
    <header
        class="w-full h-[40px] fixed top-0 left-0 flex items-center justify-end bg-noir-900/75 backdrop-blur-md shadow-md z-20">
        <a class="absolute right-4">
            ...
            @else
            <a href="{{ route('login') }}"
                class="deco-text-metallic text-gold-500 hover:text-gold-300 font-semibold mx-2">Auth</a>
            @endauth
            </nav>
    </header>
